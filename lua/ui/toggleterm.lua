-- Toggleterm UI configuration (moved from configs.ui.toggleterm)
local M = {}
...
function M.setup()
  ...
  pcall(function()
    ...
    vim.keymap.set("v", "<leader>Ts", function()
      ...
      if term then term:send(text) else vim.notify('Failed to find a terminal instance', vim.log.levels.ERROR) end
