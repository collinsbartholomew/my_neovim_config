...
function M.setup()
    ...
    wk.add({
        ...
        { "<leader>adi", "<cmd>lua require'dap'.step_into()<cr>",                           desc = "Step into" },
        { "<leader>ado", "<cmd>lua require'dap'.step_over()<cr>",                           desc = "Step over" },
        { "<leader>adO", "<cmd>lua require'dap'.step_out()<cr>",                            desc = "Step out" },
        { "<leader>adr", "<cmd>lua require'dap'.repl.toggle()<cr>",                         desc = "Toggle REPL" },
        { "<leader>adt", "<cmd>lua require'dapui'.toggle()<cr>",                            desc = "Toggle DAP UI" },
